 ...
 * 사용자 정보를 수정하고, 수정된 결과를 {@link MemberResult}로 반환합니다.
 *
...
public interface MemberUpdateService {
     ...
     * @return 업데이트된 사용자 정보를 담은 {@link MemberResult}
     */
    MemberResult updateNickName(String email, NickNameUpdateCommand command);
    ...
    MemberResult updateProfileImage(String email, MultipartFile profileImage);

    MemberResult updateProfile(String email, NickNameUpdateCommand command, MultipartFile profileImage);
}
