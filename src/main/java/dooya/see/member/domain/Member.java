package dooya.see.member.domain;
...
public class Member extends BaseEntity {
    ...
    public static Member signUpUser(String email, String name, String password, String nickName, String defaultImageUrl, Role role) {
