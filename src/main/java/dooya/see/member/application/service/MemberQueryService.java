 ...
 * {@link MemberResult} 형태로 반환해야 합니다.
 *
...
public interface MemberQueryService {
     ...
     * @return 조회된 사용자 정보를 담은 {@link MemberResult} 객체
     * @throws IllegalArgumentException 조회 대상이 없을 경우 발생 가능
     */
    MemberResult getUserByEmail(String email);

    /**
     * 모든 사용자를 조회합니다.
     *
     * @return 조회된 사용자 정보를 닮은 {@link MemberResult} 리스트
     */
    List<MemberResult> getUsers();
}
