package dooya.see.adapter.webapi.post;
...
import dooya.see.domain.post.PostPresentationMapper;
import dooya.see.domain.post.PostRequest;
import dooya.see.adapter.webapi.post.dto.PostResponse;
...
import static dooya.see.domain.post.PostPresentationMapper.*;
